...
extension UIColor {
    ...
    static let consentText = UIColor.adaptive(light: .init(hex: 0x616263), dark: .init(hex: 0x989899))
    ...
    static let privacyCenterText = UIColor.adaptive(light: .init(hex: 0x616263), dark: .init(hex: 0x8D8D93))
